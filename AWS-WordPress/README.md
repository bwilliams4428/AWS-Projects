# Highly Available and Scalable LAMP Environment To Host Word Press 
...
# 7 Auto Scaling Group & Load Balancer
 ...
 - The targets used by the Load Balancer will be registered after creating the Auto Scaling Group
